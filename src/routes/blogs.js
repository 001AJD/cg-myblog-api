...
import {  createBlogPaylodValidationRules, validatePayload } from '../validators/validateNewBlogPayload.js';

router.get('/getBlogs', getBlogsController);
router.get('/getBlog/:id', getBlogByIdController);
router.post('/createBlog', createBlogPaylodValidationRules(), validatePayload, addBlogController);
